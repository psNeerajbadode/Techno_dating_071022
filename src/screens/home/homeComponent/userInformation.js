...
const UserInformation = () => {
  ...
  return (
    <View>
      <TextFormatted
        style={{ fontSize: 16, fontWeight: '700', color: ThemeMode.selectedTheme ? theme.colors.primaryBlack : theme.colors.primary, marginLeft: 40 }}
      >
        Passions
      </TextFormatted>
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={{ height: 100, width: 100, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <TextFormatted style={{ fontSize: 16, fontWeight: '700', color: '#8490AE' }}>{item.name}</TextFormatted>
          </View>
        )}
      />
