  ...
  return (
    <View>
      <View style={{ flexDirection: 'row' }}>
            ...
            (v, i) =>
              (i != 0 && i != 2) || (
                ...
                >
                  <Image
                    source={v.img}
                    style={{ width: (dimension.width - 50) / 2, height: i == 0 ? 230 : 337, resizeMode: 'cover', borderRadius: 20 }}
                  />
                </TouchableOpacity>
              ),
          )}
        ...
        <View style={{ width: dimension.width / 2 }}>
          {potos.map(
            (v, i) =>
              (i != 1 && i != 3 && i != 4) || (
                <TouchableOpacity style={{ marginTop: 20, marginHorizontal: 10 }} onPress={() => navigation.navigate('viewImage', { imgIndex: i })}>
                  <Image
                    source={v.img}
                    style={{
      ...
      {potos.map(
        (v, i) =>
          i != 5 || (
            <TouchableOpacity style={{ marginTop: 20, alignSelf: 'center' }} onPress={() => navigation.navigate('viewImage', { imgIndex: i })}>
              <Image
                source={v.img}
                style={{
