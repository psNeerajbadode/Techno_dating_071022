  ...
  return (
    ...
    >
      ...
      <Fontisto
        ...
        style={{ alignSelf: 'flex-end', marginRight: 23, marginTop: 3, padding: 7 }}
        onPress={() => refRBSheet.current.close()}
      />
      <FlatList
        data={data}
        renderItem={({ item, index }) => (
          <TouchableOpacity style={{ flexDirection: 'row', marginHorizontal: 20, alignItems: 'center', paddingVertical: 7, marginBottom: 10 }}>
            <View
              style={{
                height: 8,
                width: 8,
