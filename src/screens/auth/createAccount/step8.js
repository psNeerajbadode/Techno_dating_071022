  ...
  return (
    <View style={{ flex: 1, backgroundColor: ThemeMode.selectedTheme ? theme.colors.primary : theme.colors.primaryBlack }}>
      <HeaderImage_1 height={170} marginBottom={1}>
        <Pagination title={'Create account'} subTitle={'Complete'} position={8} />
      </HeaderImage_1>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View style={{ flex: 1, justifyContent: 'center' }}>
          <Image
            source={require('../../../assets/icons/checked.png')}
            style={{ height: 97, width: 97, resizeMode: 'contain', alignSelf: 'center' }}
          />
          <TextFormatted
            style={{
              fontSize: 18,
          ...
          >
            Great, you have completed your profile and you are ready to start using your
          </TextFormatted>
        </View>
        <View style={{ marginVertical: 15 }}>
          <Button color={'#fff'} buttonName={'Start Tour'} onPress={() => navigation.replace('Login')} />
          <TextFormatted
            style={{
              fontSize: 14,
              fontWeight: '400',
