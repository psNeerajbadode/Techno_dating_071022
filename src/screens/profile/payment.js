    ...
    >
      ...
      <ScrollView>
        ...
        <PaymentButton
          ...
          icon={selectedType == 3 ? 'chevron-small-up' : 'chevron-small-right'}
        >
          {selectedType == 3 && (
            <View>
              <Divider />
              <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10, marginTop: 10, paddingVertical: 5 }}>
                <Image source={require('../../assets/icons/Mastercard.png')} style={{ height: 35, width: 35, resizeMode: 'contain' }} />
                <TextFormatted
                  style={{
                    fontSize: 16,
                    fontWeight: '400',
              ...
              <TouchableOpacity
                style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 15, paddingVertical: 5 }}
              ...
              >
                <LinearGradient
                  ...
                  style={{ height: 30, width: 30, borderRadius: 40, justifyContent: 'center', alignItems: 'center' }}
                >
        ...
        <View style={{ flexDirection: 'row', marginHorizontal: 22, alignItems: 'center', marginTop: 20 }}>
          ...
          <TouchableOpacity onPress={() => setAutoPayment(!autoPayment)} style={{ alignItems: 'center', alignSelf: 'center', padding: 2 }}>
            <Image
              resizeMode="contain"
      ...
      <RecapPayment refRBSheet={refRBSheet2} refRBSheet2={refRBSheet2} refRBSheet3={refRBSheet3} isPlan={isPlan} />
    ...
    >
      <ScrollView>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginHorizontal: 20, marginVertical: 20 }}>
          {!isPlan ? (
            <TextFormatted style={{ fontSize: 14, fontWeight: '500', color: theme.colors.darkGrey, marginLeft: 10, flex: 1 }}>1 Month</TextFormatted>
          ) : (
            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
              <Image source={require('../../assets/icons/Rocket.png')} style={{ height: 24, width: 24, resizeMode: 'contain' }} />
              <TextFormatted
                style={{
                  fontSize: 16,
                  fontWeight: '600',
              ...
              <TextFormatted style={{ fontSize: 14, fontWeight: '400', color: theme.colors.darkGrey, marginLeft: 10, flex: 1 }}>Boost</TextFormatted>
            </View>
          )}
          <TextFormatted
            style={{ fontSize: 16, fontWeight: '400', color: ThemeMode.selectedTheme ? theme.colors.primaryBlack : theme.colors.primary }}
          >
            1,99 €
          </TextFormatted>
        </View>
        <View style={{ flexDirection: 'row', alignItems: 'center', marginHorizontal: 20, marginVertical: 20 }}>
          <TextFormatted
            style={{ fontSize: 16, fontWeight: '600', color: ThemeMode.selectedTheme ? theme.colors.primaryBlack : theme.colors.primary, flex: 1 }}
          >
            Total price
          </TextFormatted>
          <TextFormatted
            style={{ fontSize: 26, fontWeight: '700', color: ThemeMode.selectedTheme ? theme.colors.primaryBlack : theme.colors.primary }}
          >
            1,99 €
          </TextFormatted>
        </View>
    ...
    >
      <View style={{ flex: 1, justifyContent: 'center' }}>
        <Image
          ...
          style={{ height: 97, width: 97, resizeMode: 'contain', alignSelf: 'center', marginTop: 40 }}
        />
        <TextFormatted
          style={{
            fontSize: 18,
      ...
      <Button buttonName={'Start match'} color={theme.colors.primary} marginBottom={20} onPress={() => navigation.navigate('homePage')} />
    </RBSheet>
  );
};
const PaymentButton = ({ source, title, children, icon, onPress, height, width }) => {
  const ThemeMode = useSelector(state => state.Theme);
  return (
    <View
      style={{
    ...
    >
      ...
      >
        <Image source={source} style={{ height: height || 35, width: width || 35, resizeMode: 'contain' }} />
        <TextFormatted
          style={{
            fontSize: 14,
            fontWeight: '600',
